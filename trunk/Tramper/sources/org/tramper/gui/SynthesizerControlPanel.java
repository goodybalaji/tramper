...
public class SynthesizerControlPanel extends JPanel implements SynthesisListener, ChangeListener, ActionListener, ItemListener {
    ...
    /** Synthesizer controlled by this panel */
    private SpeechSynthesizer synthesizer;

    /**
     * 
     */
    public SynthesizerControlPanel(GraphicalUserInterface main, SpeechSynthesizer synthesizer) {
	...
	this.synthesizer = aSpeechSynthesizer;
	...
	if (synthesizer != null) {
	    synthesizer.removeSpeechListener(this);
	}
    }
