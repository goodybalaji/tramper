...
public class IconFactory {
	...
	URL iconUrl = null;
        ...
        if (gender == 1) {
            //girl
            if (age == 1) {
        	iconUrl = IconFactory.class.getResource("images/girl.gif");
            //teenage girl
            } else if (age == 2) {
        	iconUrl = IconFactory.class.getResource("images/woman.png");
            //adult woman
        ...
        //man
            ...
            //boy
            if (age == 1) {
        	iconUrl = IconFactory.class.getResource("images/boy.png");
            //teenage boy
            } else if (age == 2) {
        	iconUrl = IconFactory.class.getResource("images/man.png");
            //adult man
            } else if (age == 3 || age == 4 || age == 5) {
        	iconUrl = IconFactory.class.getResource("images/man.png");
            //man without age
        ...
        //neutral (robot, ...)
            ...
            iconUrl = IconFactory.class.getResource("images/neutral.png");
        }
        ImageIcon voiceIcon = new EnhancedIcon(iconUrl);
