...
public class PlayerControlPanel extends JPanel implements PlayListener, ChangeListener, RecognitionListener {
	...
	this.setLayout(panelLayout);
        ...
        recognizerButton.setHorizontalTextPosition(SwingConstants.CENTER);
        recognizerButton.setVerticalTextPosition(SwingConstants.BOTTOM);
        String tooltip = TooltipManager.createTooltip("recognizer");
        recognizerButton.setToolTipText(tooltip);
        recognizerButton.setName("recognizer");
        recognizerButton.setActionCommand("recognizer");
        recognizerButton.addActionListener(OpenRecognizerAction.getInstance());
