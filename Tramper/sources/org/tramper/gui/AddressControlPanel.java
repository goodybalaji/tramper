...
import org.tramper.gui.fileFilter.AllFileFilter;
...
public class AddressControlPanel extends JPanel implements ActionListener {
	...
	urlButton = new JDropDownButton(listButtonActions, false, true);
        ...
        buttonIcon = new EnhancedIcon(getClass().getResource("images/about.png"));
        ...
        constraint.weightx = 0;
        constraint.insets = new Insets(2, 2, 2, 2);
        addressLayout.setConstraints(aboutButton, constraint);
    ...
    public void actionPerformed(ActionEvent event) {
	    ...
	    fileDialog.addChoosableFileFilter(allFilter);
	    ...
	    fileDialog.setFileFilter(allFilter);
